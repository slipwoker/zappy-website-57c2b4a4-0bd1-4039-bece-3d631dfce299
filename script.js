document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatableElements = document.querySelectorAll(
    ...
    '.section-header, .hero-content, .cta-block, ' +
    '.stat-item, .team-card, .blog-card, .service-card, ' +
    '.gallery-item, .partner-logo, .step-item, .benefit-item'
  );
  ...
  if (animatableElements.length > 0 && 'IntersectionObserver' in window) {
    animatableElements.forEach(function (el, index) {
      ...
      const delay = el.getAttribute('data-delay') || (index % 6) * 80;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '57c2b4a4-0bd1-4039-bece-3d631dfce299',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '57c2b4a4-0bd1-4039-bece-3d631dfce299';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '57c2b4a4-0bd1-4039-bece-3d631dfce299';
